...
- Ninject
- Unity IOC
- Built In dotnet core Injection

But my first contact with Dependency Injection was through a Framework called Simple IOC, though some say is an antipattern for me was the easiest to figure out.
